...
import 'package:flappybird_game/barriers2.dart';
...
class _HomePageState extends State<HomePage2> {
  ...
  Widget build(BuildContext context) {
    ...
    upperbarrierOneHeight = screenHeight / 2;
    lowerBarrierOneHeight = screenHeight / 3.5;

    upperbarrierTwoHeight = screenHeight / 3.5;
    lowerBarrierTwoHeight = screenHeight / 2;
